  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          { label: 'Total Scans',  value: stats.total,     color: '#7A9AB8', bg: 'rgba(122, 154, 184,0.08)',  border: 'rgba(122, 154, 184,0.2)',  icon: Target },
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: '11px', color: '#5A80A8', marginTop: '3px' }}>{label}</div>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="p-5" style={cardStyle}>
        ...
        <div className="flex flex-col gap-3 mb-5">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="flex items-center gap-2 flex-1">
              <span style={{ fontSize: '12px', color: '#3A5A7A', whiteSpace: 'nowrap' }}>From</span>
              <input type="date" value={dateFrom} onChange={e => { setDateFrom(e.target.value); setPage(1); }}
                style={{ ...inputStyle, colorScheme: 'dark', cursor: 'pointer', flex: 1 }} />
              <span style={{ fontSize: '12px', color: '#3A5A7A' }}>To</span>
            ...
            <div className="flex gap-2 ml-auto">
              {hasFilters && (
                <button
                  ...
                  style={{ color: '#3A5A7A', border: '1px solid #4A001A' }}
                >
              ...
              <button
                ...
                style={{ color: '#7A9AB8', border: '1px solid rgba(122, 154, 184,0.3)', backgroundColor: 'rgba(122, 154, 184,0.06)' }}
              >
        ...
        {/* Result count */}
        <p style={{ fontSize: '12px', color: '#3A5A7A', marginBottom: '12px' }}>
        ...
        <div className="overflow-x-auto">
          <table className="w-full" style={{ borderCollapse: 'collapse', minWidth: '700px' }}>
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan={9} className="py-14 text-center" style={{ color: '#3A5A7A', fontSize: '14px' }}>
                ...
                >
                  <td className="py-3 px-3">
                    <span style={{ fontSize: '12px', fontWeight: 600, color: '#7A9AB8', fontFamily: 'monospace' }}>
                      {entry.id}
                    </span>
                  </td>
                  <td className="py-3 px-3">
                    <span
                      ...
                      style={entry.type === 'url'
                        ? { color: '#7A9AB8', backgroundColor: 'rgba(122, 154, 184,0.1)' }
                        : { color: '#5A80A8', backgroundColor: 'rgba(90, 128, 168,0.1)' }}
                    >
                  ...
                  <td className="py-3 px-3" style={{ fontSize: '12px', color: '#5A80A8' }}>{entry.duration}</td>
                  <td className="py-3 px-3" style={{ fontSize: '11px', color: '#3A5A7A', whiteSpace: 'nowrap' }}>{entry.timestamp}</td>
                  <td className="py-3 px-3">
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between mt-4 pt-4" style={{ borderTop: '1px solid #4A001A' }}>
            <span style={{ fontSize: '12px', color: '#3A5A7A' }}>
            ...
            <div className="flex gap-1">
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1).map(n => (
                <button
                  ...
                  style={n === page
                    ? { backgroundColor: 'rgba(122, 154, 184,0.15)', color: '#7A9AB8', border: '1px solid rgba(122, 154, 184,0.3)', fontWeight: 700 }
                    : { color: '#5A80A8' }}
                >
                  {n}
                </button>
          ...
          >
            <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: '1px solid #4A001A' }}>
              <div className="flex items-center gap-3">
                {selected.type === 'url'
                  ? <Globe className="w-5 h-5" style={{ color: '#7A9AB8' }} />
                  : <Mail className="w-5 h-5" style={{ color: '#5A80A8' }} />}
              ...
              <button type="button" onClick={() => setSelected(null)} className="p-2 rounded-lg hover:bg-white/5 transition-colors" style={{ color: '#5A80A8' }} title="Close" aria-label="Close">
                <X className="w-5 h-5" />
              </button>
            </div>
            <div className="p-6 space-y-3">
              ...
              <div className="p-3 rounded-xl" style={{ backgroundColor: '#1E000A', border: '1px solid #4A001A' }}>
                <div className="flex justify-between mb-2">
                  <span style={{ fontSize: '11px', color: '#3A5A7A', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Risk Score</span>
