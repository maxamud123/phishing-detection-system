  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          { label: 'Total Scans',  value: stats.total,     color: '#00d4ff', bg: 'rgba(0,212,255,0.08)',  border: 'rgba(0,212,255,0.2)',  icon: Target },
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: '11px', color: '#6b7f9e', marginTop: '3px' }}>{label}</div>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="p-5" style={cardStyle}>
        ...
        <div className="flex flex-col gap-3 mb-5">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="flex items-center gap-2 flex-1">
              <span style={{ fontSize: '12px', color: '#4a6080', whiteSpace: 'nowrap' }}>From</span>
              <input type="date" value={dateFrom} onChange={e => { setDateFrom(e.target.value); setPage(1); }}
                style={{ ...inputStyle, colorScheme: 'dark', cursor: 'pointer', flex: 1 }} />
              <span style={{ fontSize: '12px', color: '#4a6080' }}>To</span>
            ...
            <div className="flex gap-2 ml-auto">
              {hasFilters && (
                <button
                  ...
                  style={{ color: '#4a6080', border: '1px solid #1a2040' }}
                >
        ...
        <div className="overflow-x-auto">
          <table className="w-full" style={{ borderCollapse: 'collapse', minWidth: '700px' }}>
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan={9} className="py-14 text-center" style={{ color: '#4a6080', fontSize: '14px' }}>
                ...
                >
                  <td className="py-3 px-3">
                    <span style={{ fontSize: '12px', fontWeight: 600, color: '#00d4ff', fontFamily: 'monospace' }}>
                      {entry.id}
                    </span>
                  </td>
                  <td className="py-3 px-3">
                    <span
                      ...
                      style={entry.type === 'url'
                        ? { color: '#00d4ff', backgroundColor: 'rgba(0,212,255,0.1)' }
                  ...
                  <td className="py-3 px-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="w-12 h-1.5 rounded-full overflow-hidden" style={{ backgroundColor: '#1a2040' }}>
                        <div
                  ...
                  <td className="py-3 px-3" style={{ fontSize: '12px', color: '#6b7f9e' }}>{entry.duration}</td>
                  <td className="py-3 px-3" style={{ fontSize: '11px', color: '#4a6080', whiteSpace: 'nowrap' }}>{entry.timestamp}</td>
                  <td className="py-3 px-3">
        ...
        {/* Pagination */}
        {totalPages > 1 && (
          <div className="flex items-center justify-between mt-4 pt-4" style={{ borderTop: '1px solid #1a2040' }}>
            ...
            <div className="flex gap-1">
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1).map(n => (
                <button
                  ...
                  style={n === page
                    ? { backgroundColor: 'rgba(0,212,255,0.15)', color: '#00d4ff', border: '1px solid rgba(0,212,255,0.3)', fontWeight: 700 }
                    : { color: '#6b7f9e' }}
                >
                  {n}
                </button>
      ...
      {selected && (
        ...
        >
          <div
            ...
            style={{ backgroundColor: '#0d1225', border: '1px solid #1a2040' }}
          ...
          >
            <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: '1px solid #1a2040' }}>
              ...
              <button type="button" onClick={() => setSelected(null)} className="p-2 rounded-lg hover:bg-white/5 transition-colors" style={{ color: '#6b7f9e' }} title="Close" aria-label="Close">
                <X className="w-5 h-5" />
              </button>
            </div>
            <div className="p-6 space-y-3">
              ...
              <div className="p-3 rounded-xl" style={{ backgroundColor: '#060b18', border: '1px solid #1a2040' }}>
                <div className="flex justify-between mb-2">
                  <span style={{ fontSize: '11px', color: '#4a6080', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Risk Score</span>
                  <span style={{ fontSize: '12px', fontWeight: 700, color: getScoreColor(selected.score) }}>{selected.score}/100</span>
                </div>
                <div className="w-full h-2 rounded-full overflow-hidden" style={{ backgroundColor: '#1a2040' }}>
                  <div
