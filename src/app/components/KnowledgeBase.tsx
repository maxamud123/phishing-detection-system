...
const categoryMeta: Record<string, { icon: any; color: string; bg: string; border: string }> = {
  Email:              { icon: Mail,         color: '#a78bfa', bg: 'rgba(167,139,250,0.1)',  border: 'rgba(167,139,250,0.3)'  },
  URL:                { icon: Globe,        color: '#00d4ff', bg: 'rgba(0,212,255,0.1)',    border: 'rgba(0,212,255,0.3)'    },
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          { label: 'Total Articles', value: stats.total,    color: '#00d4ff', bg: 'rgba(0,212,255,0.08)',   border: 'rgba(0,212,255,0.2)'   },
          ...
          <div key={s.label} className="p-3 rounded-xl flex items-center gap-3"
            ...
            <div>
              ...
              <div style={{ fontSize: '11px', color: '#6b7f9e', marginTop: '2px' }}>{s.label}</div>
            </div>
          </div>
        ))}
      </div>
        ...
        {CATEGORIES.map(cat => {
          ...
          return (
            <button
              ...
              style={active
                ? {
                    backgroundColor: meta ? meta.bg : 'rgba(0,212,255,0.12)',
                    border: `1px solid ${meta ? meta.border : 'rgba(0,212,255,0.35)'}`,
                    color: meta ? meta.color : '#00d4ff',
                    fontWeight: 700,
                  }
                : {
        ...
        {filtered.map(article => {
          ...
          return (
            <div
              ...
              style={{
                backgroundColor: '#0d1225',
                border: `1px solid ${isOpen ? meta.border : '#1a2040'}`,
            ...
            >
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p style={{ fontSize: '13px', color: '#6b7f9e', lineHeight: 1.5 }}>{article.summary}</p>
                  <div className="flex flex-wrap items-center gap-2 mt-2">
                    ...
                    {article.tags.slice(0, 3).map(tag => (
                      <span key={tag} className="flex items-center gap-1 px-2 py-0.5 rounded-md text-xs"
                        style={{ color: '#4a6080', backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid #1a2040' }}>
                ...
                <div className="shrink-0 mt-1" style={{ color: '#4a6080' }}>
                ...
                <div style={{ borderTop: `1px solid ${meta.border}` }}>
                  <div className="px-5 py-5 space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                      {/* Examples */}
                      {article.examples && (
                        <div className="p-4 rounded-xl space-y-2" style={{ backgroundColor: '#060b18', border: '1px solid #1a2040' }}>
